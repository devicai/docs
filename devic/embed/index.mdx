...
description: "React components that put an assistant inside your own application, connected to the public API."
---
...
<CardGroup cols={2}>
  <Card title="Configuring the widget" icon="sliders" href="/devic/embed/chat-widget">
