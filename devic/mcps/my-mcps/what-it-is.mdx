...
- **My MCPs:** connectors created by you from your own services or endpoints. Devic hosts them.
- **Connected:** remote MCP servers somebody else runs, reached by URL. See [Connected MCPs](/devic/mcps/connected-mcps).
