...
| --- | --- |
| **Name** | Unique name of the component. This is what a tool binds to, character for character. |
| **Description** | Short description of the widget’s purpose. |
| **Invoking Text / Invoked Text** | Text displayed while the widget is running, and once it has finished. |
| **Display with card border** | Whether to show the widget inside a visual card. |
