...
![Sandbox terminal](/images/environments/sandbox.png)
...
![Snapshots](/images/environments/snapshots.png)
...
From the environment you get a read-only view of the last session's commands, and a terminal of your own to work on the machine directly. The file explorer supports browsing, editing and exporting or importing a folder as a ZIP.
